...
public class TabletTest {
    ...
    public void tabletTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.step_instructions), withText("1. Preheat the oven to 350°F. Butter a 9\" deep dish pie pan."),
                        childAtPosition(
                                allOf(withId(R.id.sv_step_description),
                                        childAtPosition(
                                                withId(R.id.step_instructions),
                                                0)),
                                0),
                        isDisplayed()));
